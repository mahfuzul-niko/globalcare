            ...
            col-4 flex items-center justify-end"
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <a style="color: #000 !important"
                            href="https://www.facebook.com/sharer/sharer.php?u={{ route('single.product', [$product->id, Str::slug($product->title)]) }}"
                            target="_blank">
                            {{-- Facebook --}}
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox"
                                                ...
                                                href="{{ asset('images/product/' . $image->image) }}"><img
                                    ...
                                    @foreach ($variationProductImages as $vImage)
                                        <div class="swiper-slide">
                                            <div class="product__media--preview__items">
                                                <a class="product__media--preview__items--link glightbox"
                                                    data-gallery="product-media-preview"
                                                    href="{{ asset('images/product/' . $vImage->image) }}"><img
                                                        class="product__media--preview__items--img"
                                                        src="{{ asset('images/product/' . $vImage->image) }}"></a>
                                                <div class="product__media--view__icon">
                            ...
                            <div>
                                ...
                                @else
                                    ...
                                    <button class="ms-0 quickview__cart--btn primary__btn"
                                        ...
                                        onclick="addToCart({{ optional($product)->id }}, 'details', 'cart', 'variation')"
                                        type="button">Add To Cart</button>
                                    <button class="quickview__cart--btn primary__btn mx-3"
                                        id="buy_now_button{{ optional($product)->id }}"
                                        onclick="addToCart({{ optional($product)->id }}, 'details', 'checkout', 'variation')"
                                        type="button">Buy Now</button>
            ...
            <div class="row row-cols-1">
                <div class="col">
                    <ul class="product__details--tab d-flex mb-30 mt-5" style="border-bottom:1px solid #aba8a8;">
                        <li class="product-details-tab-list active" data-toggle="tab" data-target="#Specification">
                            Specification</li>
                        <li class="product-details-tab-list" data-toggle="tab" data-target="#description">Description
                        </li>
                        <li class="product-details-tab-list" data-toggle="tab" data-target="#reviews">Product Reviews
                        </li>
                    </ul>
