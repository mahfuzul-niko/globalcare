            ...
            <div class="row mb-9">
                ...
                <div class="col-lg-7 pr-lg-4 mb-4 p-3">
                    ...
                    <div class="row gutter-sm">
                        <div class="col-md-12 mb-3">
                            <div class="checkout__input--list checkout__input--select select">
                                <label class="checkout__select--label"> Shipping area<span class="text-danger">*</span></label>
                                ...
                                <option value="">Please Chose Your Shipping Area </option>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea name="shipping_address" id="" cols="30" rows="10" required placeholder="House number and street name" class="checkout__input--field border-radius-5 mb-2" >{{ optional(Auth::user())->address }}</textarea>
